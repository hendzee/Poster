          ...
          children: <Widget>[
            Container(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  SizedBox(width: 25,),
                  this._setCategoriesTab('Around World', true),
                  SizedBox(width: 25,),
                  this._setCategoriesTab('Another Trend', false),
                  SizedBox(width: 25,),
                  this._setCategoriesTab('Recomended', false),
                  SizedBox(width: 25,),
                ],
              ),
            ),
              ...
              child: ListView(
                children: <Widget>[
                  Padding(
                    ...
                    child: PosterCard(posterCardModel: posterCardModel1,),
                  ),
                  Padding(
                    padding: const EdgeInsets.only(right: 25, left: 25, bottom: 25),
                    child: PosterCard(posterCardModel: posterCardModel1,),
