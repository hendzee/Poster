                    ...
                    children: [
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: Icon(EvaIcons.emailOutline, color: Colors.white,),
                          labelText: 'Email',
                      ...
                      TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          prefixIcon: Icon(EvaIcons.personOutline, color: Colors.white,),
                          suffixIcon: IconButton(
                            icon: Icon(
                              _isPasswordSecure ? EvaIcons.eyeOff2Outline : EvaIcons.eyeOutline,
                              color: Colors.white,
                            ),
                            onPressed: (){
                              this.setState(() {
                      ...
                      Padding(
                        ...
                        child: Text('Dont\' have account yet ?', style: TextStyle(color: Colors.white),),
                      ),
                      Container(
                        width: double.infinity,
                        height: 50,
